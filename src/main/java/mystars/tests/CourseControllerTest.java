 ...
 * 
 * This class performs the required testing and validation to ensure that the respective
 * controllers are able to perform their required functionality correctly.
 */
class CourseControllerTest {
	...
	@BeforeEach
	/**
	 * Before each test, this method wipes the storage object since no valid file was found.
	 * 
	...
	void test_registration() throws AppException {
		...
		// Check if the following conditions are true, and throw an assertion error otherwise.
	...
	void test_dropping() throws AppException {
		...
		// Check if the following conditions are false, and throw an assertion error otherwise.
	...
	@Test
	/**
	 * Test for the successful assigning of a student to the index if there are vaccancies.
	 * Test for the placement of a student onto the waitlist if there are no vaccancies.
	 * 
	 * @throws AppException Shows error message if any of the tests fail.
	 */
	void test_waitlist() throws AppException {
		...
		// Check if the values are equal to within a positive delta range, and throw an assertion error otherwise.
