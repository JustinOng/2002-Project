 ...
 * 
 * This manages the user interface when getting inputs from the user as a string or numerical value.
 */
public class GetInputForm {
	/**
	 * Shows a dialog prompt for the user's input, and returns a string input obtained from the user.
	 * 
	...
	/**
	 * Shows a dialog prompt for the user's input, and returns a numerical input displayed by the user.
	 * Checks for the error of user's input not being numerical.
	 * 
	 * @param gui			The graphical user interface object.
	 * @param title			The title of the prompt window.
	 * @param description	The description for the input in the prompt window.
