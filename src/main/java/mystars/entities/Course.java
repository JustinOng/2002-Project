 ...
 *
 *
 *This course class manages the logic courseController. 
 *It performs all the function that are required for courseController.
...
public class Course extends Entity {
	...
	*/
	 ...
	 *This class is responsible for the creation of a course object.
	 * 
	...
	* @throws AppException 	If the courseCode already exist.
   	*/
	...
	/**
   	* Gets Course's name from a courseCode input.
	...
	/**
   	* Gets Course code from a courseCode input.
	...
	/**
   	* Creates a new Index with the given index number and maximum enrolled number of students
   	* and place it into the hash map for indexes
	...
	* @return studentList 	This method returns all of the students that registered in the course as a new ArrayList
	*/
	...
	*/
	...
	/** 
	* This method changes the student's index from the current index to the targeted index of targetIndexNo
